...
router.post("/create", validate(createPerformanceInvoiceSchema), PerformanceInvoiceController.createPerformanceInvoice);
...
router.patch("/update/:id", validate(updatePerformanceInvoiceSchema), PerformanceInvoiceController.updatePerformanceInvoice);
